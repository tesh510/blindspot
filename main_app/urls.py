...
urlpatterns = [
  ...
  path('cars/search_cars', views.search_cars, name='search_cars'),
  ...
  # path('reviews/<int:review_id>/update', views.ReviewUpdate.as_view(), name='reviews_update'),
  # path('reviews/<int:review_id>/delete', views.ReviewDelete.as_view(), name='reviews_delete'),
